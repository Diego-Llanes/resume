#set document(author: "Diego Llanes", title: "Resume / CV")
...
#let education(institution: "", major: "", date: "", location: "", description: "", gpa: "") = {
  ...
  h(1fr)
  text(11pt, fill: subheadings-colour , weight: "medium")[#gpa GPA \ ]
...
// Projects
#let project(title: "", description: "", date: "", company: "") = {
  ...
  if company != [] or company != "" {
    text(11pt, fill: primary-colour, weight: "extralight",)[#emph(company) \ ]
  } 
...
#let cv(
  ...
  if continue-header == "true" {
    ...
    set page(margin: (left: 1cm, right: 1cm, top: 0.75cm, bottom: 0.75cm))
    text(
      18pt,
      fill: primary-colour,
      weight: "bold",
